...
export class PaymentService {
    getSamplePaymentDto(shopId: string, receiptId: string, paymentId: string): PaymentDto {
        ...
        return {
            ...
            adjusted_gross: new AmountDto('' + Math.floor(Math.random() * (300 - 10 + 1)) + 10, 100, 'USD'),
            adjusted_fees: new AmountDto('' + Math.floor(Math.random() * (300 - 10 + 1)) + 10, 100, 'USD'),
            adjusted_net: new AmountDto('' + Math.floor(Math.random() * (300 - 10 + 1)) + 10, 100, 'USD'),
            currency: 'USD',
            shop_currency: 'USD',
            buyer_currency: 'USD',
